...
public class Lesson implements Serializable {
    ...
    public boolean isAvailable(Lesson lesson2) {
        if (room!=null && lesson2.room!=null) {
            ...
            if (((room.equals(lesson2.room1) ||
                room.equals(lesson2.room2)) &&
                ((timeSlot.equals(lesson2.timeSlot) ||
                    (timeSlot.overLap(lesson2.timeSlot)))))) {
                return false;
            } else {
                return true;
            }
        } else if (room1!=null&&room2!=null && lesson2.room!=null) {
            if ((room1.equals(lesson2.room) ||
                room2.equals(lesson2.room)) &&
                ((timeSlot.equals(lesson2.timeSlot) ||
                    (timeSlot.overLap(lesson2.timeSlot))))) {
                return false;
            } else {
            ...
            if (((room1.equals(lesson2.room1) ||
                room2.equals(lesson2.room1)) ||
                (room1.equals(lesson2.room2) ||
                    room1.equals(lesson2.room1)) &&
                    (timeSlot.equals(lesson2.timeSlot) ||
                        timeSlot.overLap(lesson2.timeSlot)))) {
                return false;
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        return this.timeSlot.equals(other.timeSlot) &&
            ...
            this.room1.equals(other.room1) &&
            this.room2.equals(other.room2);
    }
